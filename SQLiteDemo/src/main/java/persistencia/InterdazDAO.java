...
public interface InterdazDAO {
    ...
    public abstract boolean delate(Object obj) throws SQLException;
    public abstract ArrayList obtenerTodo() throws SQLException;
    public abstract boolean buscarPorId(String id) throws SQLException;
